...
export default function Awards() {
  ...
  return (
    <section id="achievements" className="relative py-24 md:py-32 px-4 md:px-8 bg-bg-surface overflow-hidden">
      ...
      <div className="mx-auto max-w-7xl relative z-10">
        ...
        {/* Timeline Grid */}
        <div className="relative border-l border-border-subtle pl-6 md:pl-12 max-w-4xl mx-auto space-y-12">
          ...
          {RECOGNITIONS.map((award, idx) => {
            ...
            return (
              ...
              >
                ...
                {/* Main Card */}
                <div className="glass-panel border-border-subtle p-6 md:p-8 rounded-2xl group-hover:border-gold-500/20 transition-all duration-300 relative overflow-hidden">
                  ...
                  <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
                    <div className="space-y-3">
                      ...
                      <div className="flex items-center space-x-2.5">
                        ...
                        <span className="text-[10px] md:text-xs font-mono text-text-tertiary uppercase tracking-wider">
                          {award.issuer}
                        </span>
                      </div>
        ...
        <div className="mt-20 text-center text-xs font-mono text-text-tertiary">
